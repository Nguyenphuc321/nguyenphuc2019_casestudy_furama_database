create database case_study_furama_database2;
create table khachhang(
id_khachhang int auto_increment primary key,
ho_ten varchar(45) not null,
ngay_sinh date,
So_CMTNN varchar(45) not null,
...
insert into khachhang(id_khachhang,ho_ten,ngay_sinh,So_CMTNN ,SDT,email,Diachi,id_loaikhachhang) values(8,'nguyen van H','1998-4-12','34995957','05994599','phuvkj@gmail.com','thienb long',"8");
insert into khachhang(id_khachhang,ho_ten,ngay_sinh,So_CMTNN ,SDT,email,Diachi,id_loaikhachhang) values(9,'nguyen van I','1998-12-12','34995957','05994599','phuvkj@gmail.com','thienb long',"9");
insert into khachhang(id_khachhang,ho_ten,ngay_sinh,So_CMTNN ,SDT,email,Diachi,id_loaikhachhang) values(10,'nguyen van K','1998-12-12','34995957','05994599','phuvkj@gmail.com','thienb long',"10");

select ngay_sinh,diachi * from khachhang ('1-1-2001->1-1-1970','danang or quangtri');
select*from khachhang inner join khachhang on khachhang.id_loaikhachhang = loaikhach.id_loaikhachhang;
...
select*from khachhang inner join khachhang on hopdong.id_khachhang = khachhang.id_khachhang
